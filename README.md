...
- 📚 &nbsp;Atualmente, sou estudante de Sistemas de Informação e gosto de construir aplicações bem estruturadas. Tenho um grande interesse por arquitetura de software e system design, procurando estudar e aplicar Design Patterns, os princípios SOLID e abordagens como Clean Architecture, Hexagonal Architecture, Domain Driven Design (DDD) e Test-Driven Development (TDD), sempre buscando escrever um código limpo, performático e de fácil manutenção.
